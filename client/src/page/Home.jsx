  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]"><i><strong>Note:</strong> These images were created previously by users with different prompts and shared with the community.</i></p>
      </div>
